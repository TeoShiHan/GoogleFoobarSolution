...
public class SolutionR {
    ...
    public static int[] solution(int[][] m) {
        ...
        System.out.println("\nunsimp ans  matrix = ");
        System.out.println(Arrays.toString(unsimplifiedAns));
